...
class eve_sim(gr.top_block):
    ...
    def __init__(self, snr_db_ae = 15, signal_len = 1024, samp_rate = 100000, const_index = 3):
...
def run_sims(top_block_cls=eve_sim, options=None):
    ...
    for mod_index in range(4):
        sims.append(top_block_cls(snr_db_ae, signal_len, samp_rate, mod_index))
        ...
        for curr_samp in range(samples_to_check):
